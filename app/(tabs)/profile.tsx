...
// --- Constants ---
const PRIVACY_POLICY_URL = "http://chatabubble.com/privacy-policy"; // <-- REPLACE THIS URL
const TERMS_OF_SERVICE_URL = "http://chatabubble.com/terms-of-service"; // <-- Optional: REPLACE THIS

// --- ProfileHeader Component (Unchanged) ---
const ProfileHeader = ({
  user,
  lastActive,
  onEditProfile
...
// --- SettingsRow Component (Unchanged) ---
const SettingsRow = ({
  icon,
  title,
  description,
...
// --- DangerAction Component (Unchanged) ---
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      await EncryptionService.handlePasswordChange(
        user.id,
        confirmPassword, // Assuming confirmPassword holds the old password (might need adjustment)
        newPassword
      );
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        {/* --- NEW: Legal Section --- */}
        <Animated.View
          entering={FadeInDown.delay(350).springify()} // Adjusted delay
          layout={Layout.springify()}
        >
          <View style={styles.settingsSection}>
            <Heading3 style={styles.sectionTitle}>Legal</Heading3>
            <Card variant="elevated" style={styles.settingsCard}>
              <CardContent style={styles.settingsCardContent}>
                <SettingsRow
                  icon="shield" // Or 'file-text'
                  title="Privacy Policy"
                  onPress={() => openLink(PRIVACY_POLICY_URL)}
                  rightIcon="external-link" // Use external link icon
                />
        ...
        {/* Danger Zone Section */}
        <Animated.View
          entering={FadeInDown.delay(400).springify()} // Adjusted delay
          layout={Layout.springify()}
        >
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#fff", // Or theme.colors.background.default
  },
  header: {
  ...
  statDivider: {
    width: 1,
    height: 40,
    backgroundColor: "#E0E0E0", // Or theme.colors.divider
  },
  refreshButton: {
    width: 36,
    height: 36,
  ...
  settingsRow: {
    ...
    padding: 16,
    borderBottomWidth: 1,
    borderBottomColor: "#F3F4F6", // Or theme.colors.divider
  },
  settingsIcon: {
    width: 40,
    height: 40,
  ...
  dangerCard: {
    backgroundColor: "#FEF2F2", // Or theme.colors.error.light
  },
  dangerCardContent: {
    padding: 0,
  },
  dangerRow: {
    ...
    padding: 16,
    borderBottomWidth: 1,
    borderBottomColor: "#FEE2E2", // Or theme.colors.error.light
  },
  modalContainer: {
    flex: 1,
  ...
  modalContent: {
    ...
    padding: 24,
    paddingTop: 32,
    paddingBottom: 48, // Adjust as needed for safe area
  },
  deleteModalContent: {
    maxHeight: "80%",
  },
  ...
  deleteModalTitle: {
    marginBottom: 16,
    color: "#EF4444", // Or theme.colors.error.main
  },
